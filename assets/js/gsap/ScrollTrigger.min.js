...
! ( function ( e, t ) {
	...
	function G( r, n ) {
		function dd( e ) {
			if ( e || 0 === e ) {
				...
				( n || qe.cache !== dd.cacheID || o( 'ref' ) ) &&
					( ( dd.cacheID = qe.cache ), ( dd.v = r() ) );
	...
	function J( e, t ) {
		return (
			( ( t && t._ctx && t._ctx.selector ) || Te.utils.toArray )(
				e
			)[ 0 ] ||
	...
	function K( t, e ) {
		...
		return (
			...
			a ||
				( s.smooth =
					'smooth' === Te.getProperty( t, 'scrollBehavior' ) ),
			s
		);
	}
	function L( e, t, i ) {
	...
	var k =
		( ( Observer.prototype.init = function init( e ) {
			...
			( this.target = o = J( o ) || Ee ),
				...
				( r =
					r ||
					parseFloat( Se.getComputedStyle( Pe ).lineHeight ) ||
					22 );
			var ee,
				te,
				re,
				...
				( se.enable = function ( e ) {
					return (
						se.isEnabled ||
							( B( ve ? be : o, 'scroll', F ),
							0 <= t.indexOf( 'scroll' ) &&
								B( ve ? be : o, 'scroll', of, ue, j ),
							0 <= t.indexOf( 'wheel' ) &&
								B( o, 'wheel', pf, ue, j ),
							( ( 0 <= t.indexOf( 'touch' ) && Me ) ||
								0 <= t.indexOf( 'pointer' ) ) &&
								( B( o, Be[ 0 ], we, ue, j ),
								B( be, Be[ 2 ], _e ),
								B( be, Be[ 3 ], _e ),
	...
	function Ca( e, t, r ) {
		var n =
			ct( e ) &&
			( 'clamp(' === e.substr( 0, 6 ) || -1 < e.indexOf( 'max' ) );
	...
	function Ka() {
		return (
			He || ( Ja() && ( He = window.gsap ) && He.registerPlugin && He )
		);
	}
	function La( e ) {
		return !! ~l.indexOf( e );
	...
	function Rb( e ) {
		for ( var t = 0; t < j.length; t += 5 )
			( ! e || ( j[ t + 4 ] && j[ t + 4 ].query === e ) ) &&
				...
				j[ t ].getBBox &&
					j[ t ].setAttribute( 'transform', j[ t + 2 ] || '' ),
				( j[ t + 3 ].uncache = 1 ) );
	}
	function Sb( e, t ) {
		var r;
			...
			( ( ScrollTrigger.prototype.init = function init( M, O ) {
				if (
					...
					var A,
						...
						he =
							M.horizontal ||
							( M.containerAnimation && ! 1 !== M.horizontal )
								? Fe
								: ze,
						ve = ! E && 0 !== E,
						be = J( M.scroller || Ne ),
						...
						Te = me
							? 0
							: parseFloat( mb( be )[ 'border' + he.p2 + yt ] ) ||
							  0,
						Ce = this,
						Se =
							M.onRefreshInit &&
				...
				if (
					...
					for (
						o.revert ||
							...
							r ||
								( Je.setAttribute( 'style', '' ),
								Je.removeAttribute( 'style' ) ),
				...
				var n = e.getBoundingClientRect(),
					...
					o =
						null == t
							...
							: parseFloat( t ) || 0;
				return r
					? ( n.left + o ) / Ne.innerWidth
					: ( n.top + o ) / Ne.innerHeight;
			} ),
	...
	function Bc( e ) {
		...
		return (
			...
			( e.onPress = function () {
				...
				var e = y;
				( y = Ia(
					( ( Ne.visualViewport && Ne.visualViewport.scale ) || 1 ) /
						x
				) ),
					a.pause(),
					e !== y && uc( p, 1.01 < y || ( ! f && 'x' ) ),
				...
				function ( e, t ) {
					if ( ( b.offset && Fq(), t ) ) {
						...
						f &&
							( ( n =
								( r = m() ) +
								( 0.05 * i * -e.velocityX ) / 0.227 ),
							( i *= tc( m, r, n, Qa( p, Fe ) ) ),
							( a.vars.scrollX = C( n ) ) ),
							( n =
								( r = b() ) +
								( 0.05 * i * -e.velocityY ) / 0.227 ),
							( i *= tc( b, r, n, Qa( p, ze ) ) ),
							( a.vars.scrollY = S( n ) ),
