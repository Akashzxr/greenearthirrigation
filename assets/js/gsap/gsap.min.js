...
! ( function ( t, e ) {
	...
	function ea( t ) {
		...
		for ( r = t.length; r--;  )
			( t[ r ] &&
				( t[ r ]._gsap || ( t[ r ]._gsap = new Vt( t[ r ], e ) ) ) ) ||
				t.splice( r, 1 );
		return t;
	}
	function fa( t ) {
	...
	function Ea( t ) {
		return t._repeat
			? Tt( t._tTime, ( t = t.duration() + t._rDelay ) ) * t
			: 0;
	}
	function Ga( t, e ) {
		return (
	...
	function Ka( e, r, i, n ) {
		return (
			r.parent && za( r ),
			( r._start = ja(
				( t( i ) ? i : i || e !== I ? xt( e, i, r ) : e._time ) +
					r._delay
			) ),
			( r._end = ja(
				r._start +
					( r.totalDuration() / Math.abs( r.timeScale() ) || 0 )
			) ),
	...
	function wb( t ) {
		if ( t )
			if (
				( ( t = ( ! t.name && t.default ) || t ), x() || t.headless )
			) {
				var e = t.name,
					r = s( t ),
					i =
	...
	function Cb( t, e, r ) {
		...
		if (
			...
			for (
				s = ( n = t.replace( Et, '1' ).split( rt ) ).length - 1;
				l < s;
				l++
			)
				o +=
				...
				? ( ( a = e.charAt( 0 ) ),
				  ...
				  '<' === a || '>' === a
						? ( 0 <= n && ( e = e.replace( /=/, '' ) ),
						  ( '<' === a
								? u._start
								: u.endTime( 0 <= u._repeat ) ) +
								( parseFloat( e.substr( 1 ) ) || 0 ) *
									( s
										? ( n < 0 ? u : i ).totalDuration() /
										  100
										: 1 ) )
						: n < 0
						? ( e in o || ( o[ e ] = h ), o[ e ] )
			...
			( g = {
				...
				add: function add( n, t, e ) {
					var a = t
						...
						: n;
					return (
						g.remove( n ), Y[ e ? 'unshift' : 'push' ]( a ), Ft(), a
					);
				},
		...
		Ut =
			...
			( qt.timeScale = function timeScale( t, e ) {
				...
				return (
					...
					this.totalTime(
						kt( -Math.abs( this._delay ), this._tDur, r ),
						! 1 !== e
					),
					Ha( this ),
	...
	var Xt = ( function ( i ) {
		...
		return (
			...
			( e.getTweensOf = function getTweensOf( e, r ) {
				for (
					var i, n = [], a = Mt( e ), s = this._first, o = t( r );
					s;
			...
			( e.render = function render( t, e, r ) {
				...
				if ( p ) {
					if (
						...
						if (
							( ( i = m ), ( l = this.timeline ), this._repeat )
						) {
							if (
								( ( s = p + this._rDelay ),
								this._repeat < -1 && _ )
	...
	function _d( t, e, r, i ) {
		...
		return (
			f &&
				_ &&
				( ( ( s = fa( a ) ).time = Rt.time ), ( s.width = a[ c ] ) ),
	...
	function oe( t, e, r ) {
		var i = Ya( e );
		return (
			ia( parseFloat( e ) + parseFloat( _d( t, 'x', r + 'px', i ) ) ) + i
		);
	}
